...
!! By Zhang for C/N cycling
	...
	real, dimension(:), allocatable :: sedc_a, surfqc_a, latc_a, 
     ...
     &  soc_a, rspc_a	
      ...
      integer, allocatable ::ori_kast_dj,ori_kast_pj,sub_karst,api_idum
      real, dimension(:), allocatable ::sur_rchrg_karst,sur_karst_height,Q_sur_sec,Q_sur_eh,Q_karst_S
      real, dimension(:), allocatable ::Q_karst_F,Q_karst_FM,karst_FM_height,karst_sc
      real, dimension(:), allocatable ::sub_sec,sub_EH,sub_FM
      real::alpha_delay1,sur_karst_h1,sur_karst_h2,sur_connect,alpha_eh,alpha_delay2,alpha_FM
      real::k_sec,k_eh,k_f,alpha_sc,k_sc,gw_karst_delaye,gw_alpha_bfe,karst_he,karst_hs,karst_hf
      real::k_fm,RCN11,gw_karst_h1,gw_karst_h2
      integer, dimension(:), allocatable ::gw_karst_hru,karst_hru	,karst_type
      integer, allocatable ::cn_flag,station_flag,api_id
       real, dimension(:), allocatable ::karst_parm,sub_karst_SEC_EH,sub_karst_FM,epikarst_recharge,Aquifer_recharge,
     &  Conduct_recharge,Matrix_conduct_flow_exchange,Q_karst_S1,Q_karst_F1
       real, dimension(:,:), allocatable ::pre_pcp,origin_sol_k_parm
       real, dimension(:), allocatable ::IWAPI,WAPI,IWAPI_1,WAPI_1,wapi_all,wapi_all_1 ,origin_gw1_parm,origin_gw2_parm ,
     &  origin_esco_parm,origin_brt_parm,origin_ch_n,origin_ch_k,karst_sc1
      real, allocatable ::origin_Ia,surf_Ia
