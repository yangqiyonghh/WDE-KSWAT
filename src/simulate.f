...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      alpha_delay1=sftmp!(0.1-5)            ܴ    ӳ ϵ       Ǳ                   һ   ӾͲ        ܴ  У       ʱ   ɷָ ʪ ڼ 
      alpha_delay2=smtmp!(0.1-5)      ܴ    ݸ    ʵĹ  ̣ ,      ʱ   ɷָ ʪ ڼ 
      sur_karst_h1=smfmn!(1-50)      ܴ      ӳ       ֵˮ  
      sur_karst_h2=smfmn+smfmx!(1-20)      ܴ               ֵˮ  
      k_sec=timp!(0.0001-0.5)      ܴ        ĳ         ϵ  (   Գ   )   ɷָ ʪ ڼ 
      k_eh=snocovmx!(0.0001-0.5)      ܴ  ӳٳ         ϵ     ɷָ ʪ ڼ 
      alpha_eh=sno50cov!(0.5-2)      ܴ  ӳٳ   ָ  ϵ     ɷָ ʪ ڼ 
      k_f=spcon_bsn!(0.0001-0.5)      ܴ    ݸ  ܵ                   ݷ ʽ  һ       Դ  ݣ  ɷָ ʪ ڼ 
      gw_karst_delaye=spexp_bsn!(0.1-5)           ܻ  ʵ  ӳ ϵ     ɷָ ʪ ڼ 
      gw_alpha_bfe=n_updis!(0.1-5)       ܻ  ʳ      ӳ ϵ     ɷָ ʪ ڼ 
      k_fm=p_updis!(0.0001-0.5) ܵ    ĳ   ϵ     ɷָ ʪ ڼ 
      alpha_FM=pperco_bsn!(0.5-3) ܵ    ı     ָ  ϵ  ?   ɷָ ʪ ڼ 
      k_sc=phoskd_bsn!(0.0001-0.5)   ʺ͹ܵ  Ľ   ϵ     ɷָ ʪ ڼ 
      alpha_sc=psp_bsn!(0.1-1)   ʺ͹ܵ  Ľ   ָ     ɷָ ʪ ڼ 
      karst_he=RCN11 !(1-25)      ܴ   ʼˮ  
      karst_hs=nperco_bsn!(1-25)   ʳ ʼˮ  
      karst_hf=eros_spl!(1-25) ܵ   ʼˮ  
      gw_karst_h1=wdpq!   ܻ     ֵˮ  (1-50)
      gw_karst_h2=wgpq!   ܹܵ   ֵˮ  (1-50)
      sub_karst=1 !1:      ,0: 轭    
      cn_flag=0! ޸ CN
      call gw_karst_num   !   º           ı  
      eof = 0
