...
!! read basin parameters
      ...
      read (103,*) cncoef! !δ  
      read (103,*) cdn_bsn! !δ  
      read (103,*) sdnco_bsn !δ  
      read (103,*) bact_swf! !δ  
      read (103,*,iostat=eof) bactmx! !δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) bactminlp!! !δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) bactminp!! !δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) wdlprch!! !δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) wdprch!! !δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) wdlpres!! !δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) wdpres!! !δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) tb_adj!! !δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) depimp_bsn!! !δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) ddrain_bsn! !δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) tdrain_bsn!! !δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) gdrain_bsn!! !δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) cn_froz
      if (eof < 0) exit
      read (103,*,iostat=eof) dorm_hr
      if (eof < 0) exit
      read (103,*,iostat=eof) smxco  !δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) fixco!!δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) nfixmx!!δ  
      if (eof < 0) exit
      ...
      if (eof < 0) exit
      read (103,*,iostat=eof) bc1_bsn!!δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) bc2_bsn!!δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) bc3_bsn!!δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) bc4_bsn!!δ  
      if (eof < 0) exit
      read (103,*,iostat=eof) decr_min!!δ  
      if (eof < 0) exit
 ...
 !!   subdaily erosion modeling by Jaehak Jeong
      read (103,*,iostat=eof) titldum
      if (eof < 0) exit
      read (103,*,iostat=eof) eros_spl!δ  
      if (eof < 0) exit
