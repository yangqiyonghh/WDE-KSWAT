...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      luse=titldum(aa:bb)
      if (luse=="AGRL")karst_hru(ihru)=2! ݵ     hru
      if (luse=="FRST")karst_hru(ihru)=2! ݵ     hru,
      if (luse=="PAST")karst_hru(ihru)=2! ݵ     hru,
      if (luse=="WATR")karst_hru(ihru)=2! ݵ     hru,
      if (luse=="URBN")karst_hru(ihru)=2! ݵ     hru,
      if (luse=="BARR")karst_hru(ihru)=2! ݵ     hru,
      ...
      if (luse=="WATR" .or. luse=="WAT5" )karst_type(ihru)=1
      ...
      if (luse=="WAT3" .or. luse=="WAT2" )karst_type(ihru)=2
      ...
      if (luse=="WAT4")karst_type(ihru)=3
      if (luse=="URB4")karst_type(ihru)=3      
      if (luse=="BAR4")karst_type(ihru)=3
