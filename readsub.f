...
!!    set default values
      ...
      do ib = 1, 10
        if (sub_smtmp(ib,i) < 1.e-6) sub_smtmp(ib,i) =0.5   
        if (sub_sftmp(ib,i) < 1.e-6) sub_sftmp(ib,i) = -10      
        if (sub_smfmx(ib,i) < 1.e-6) sub_smfmx(ib,i) =4.5
        if (sub_smfmn(ib,i) < 1.e-6) sub_smfmn(ib,i) =4.5
        if (sub_timp(ib,i) < 1.e-6) sub_timp(ib,i) = 1
      end do
