...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      do ib = 1, 10
          if (sub_sftmp(ib,i) <= 0.) sub_sftmp(ib,i) = -10
          if (sub_smtmp(ib,i) <= 0.) sub_smtmp(ib,i) = 0.5
          if (sub_smfmx(ib,i) <= 0.) sub_smfmx(ib,i) = 4.5
          if (sub_smfmn(ib,i) <= 0.) sub_smfmn(ib,i) =4.5
          if (sub_timp(ib,i) <= 0.) sub_timp(ib,i) = 1
      end do
